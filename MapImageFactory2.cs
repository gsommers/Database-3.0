...
namespace Mapbox.Unity.MeshGeneration.Factories
{
	...
	/// </summary>
	[CreateAssetMenu(menuName = "Mapbox/Factories/Map Image Factory 2")]
	public class MapImageFactory2 : AbstractTileFactory
	{
		[SerializeField]
		private MapImageType2 _mapIdType;
